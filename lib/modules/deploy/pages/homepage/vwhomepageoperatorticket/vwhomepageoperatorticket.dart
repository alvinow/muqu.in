...
import 'package:matrixclient/modules/deploy/pages/homepage/dashboard2024/dashboard2024.dart';
import 'package:matrixclient/modules/deploy/pages/homepage/dashboard2024realtime/dashboard2024realtime.dart';
...
class VwHomePageOperatorTicket extends StatelessWidget {
  ...
  static VwHomeTabItem createLHPDashboardTabItem(
    ...
    return VwHomeTabItem(
        ...
        tabPage:
        Dashboard2024Realtime(appInstanceParam: appInstanceParam)
