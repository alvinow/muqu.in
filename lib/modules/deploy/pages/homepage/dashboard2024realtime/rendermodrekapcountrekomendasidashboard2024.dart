...
class RenderModRekapCountRekomendasiDashboard2024 extends StatefulWidget {
  RenderModRekapCountRekomendasiDashboard2024({required this.fieldValue});
  final VwFieldValue fieldValue;
  RenderModRekapRekomendasiDashboard2024State createState() =>
      RenderModRekapRekomendasiDashboard2024State();
}

class RenderModRekapRekomendasiDashboard2024State
    extends State<RenderModRekapCountRekomendasiDashboard2024> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<ChartData> chartData =RenderModRekapRekomendasiDashboard2024State.createChartDataList(widget.fieldValue.valueRowDataList!);
    return Container(
        ...
        body: Center(
            child: Container(
                child: SfCartesianChart(
                  title: ChartTitle(text:'Rekap Jumlah Status Rekomendasi Per Tahun Anggaran'),
