...
typedef FloatingActionButtonAddOn= FloatingActionButton Function(BuildContext context);
...
class VwHomePageBase extends StatefulWidget {
  VwHomePageBase({
    ...
    this.floatingActionButtonAddOn
  });

  final FloatingActionButtonAddOn? floatingActionButtonAddOn;
...
class _VwHomePageBaseState extends State<VwHomePageBase> {
  ...
  Widget build(BuildContext context) {
    ...
    if (this.widget.homeTabItemList.isEmpty == true) {
      ...
      return MaterialApp(
          home: Scaffold(
            floatingActionButton: widget.floatingActionButtonAddOn!=null?widget.floatingActionButtonAddOn!(context):null,
